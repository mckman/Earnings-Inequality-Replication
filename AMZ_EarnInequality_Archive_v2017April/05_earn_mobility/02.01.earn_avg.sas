*** Print the Average Earnings Distribution Change Flows ****;
...
proc summary data=dot.hc_dist1 nway;
   class earn_type;
...
data temp3(drop=max count);
   ...
   vertex1="a" || put(substr(earn_type,1,1),1.);
   vertex2="b" || put(substr(earn_type,3,1),1.);
