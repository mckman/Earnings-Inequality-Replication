...
proc summary data=temp1 nway;
   ...
   output out=dot.work_ft_pt_et sum(year1_num_qtrs year1_long_job year1_num_jobs year2_num_qtrs year2_long_job year2_num_jobs)=sum1_nq sum1_lj sum1_nj sum2_nq sum2_lj sum2_nj;
run;

proc print data=dot.work_ft_pt_et;
